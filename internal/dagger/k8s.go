...
func setupRemoteEngine(ctx context.Context, kubeNamespace, podName string) error {
	...
	var pod *v1.Pod
	pod, err = clientset.CoreV1().Pods(kubeNamespace).Get(ctx, podName, metav1.GetOptions{})
